...
DROP TABLE IF EXISTS `t_sys_upload_task`;
CREATE TABLE `t_sys_upload_task` (
                                   `id` bigint NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='分片上传-分片任务记录';
